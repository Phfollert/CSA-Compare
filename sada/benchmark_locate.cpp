...
{	
	...
	ofstream result1,result2,result3,result4,result5,result6,error1,error2,error3,error4,error5,error6;
  	result1.open("dna50mb_locate.txt");
  	result2.open("dna100mb_locate.txt");
  	result3.open("dna200mb_locate.txt");
  	result4.open("english50mb_locate.txt");
  	result5.open("english100mb_locate.txt");
  	result6.open("english200mb_locate.txt");
  	error1.open("dna50mb_locate_error.txt");
  	error2.open("dna100mb_locate_error.txt");
  	error3.open("dna200mb_locate_error.txt");
  	error4.open("english50mb_locate_error.txt");
  	error5.open("english100mb_locate_error.txt");
  	error6.open("english200mb_locate_error.txt");
	...
	for (i=2000; i<2100; i++){
        ...
        for(j=0; j<times; j++){
            ...
            locate(csa, pattern.begin(), pattern.begin()+i+1);
